...
Serial.write (blut.read());
   ...
   /*
    ...
    display.print ("a1: ");                //Impresion de hola mundo
    display.setCursor(0, 37);                     //Poscion del cursor
    display.print ("a2: ");                //Impresion de hola mundo
    display.setCursor(0, 39);                     //Poscion del cursor
    display.print ("Px: ");                //Impresion de hola mundo
 display.setCursor(0, 45);                     //Poscion del cursor
    display.print ("Py: ");                //Impresion de hola mundo
*/
...
if (index1 != -1 && index2 != -1) { // Si se encuentran los dos espacios
  ...
  dato3 = dato.substring(index2 + 1); // La tercera parte de la cadena después del segundo espacio es el tercer dato
